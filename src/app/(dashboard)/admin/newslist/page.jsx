              ...
              >
                ...
                >
                  ...
                  <button onClick={async () => {
                    setOpenModal(true)
                    await dispatch(GetHealthNewsIdService(row?._id))
                  }}>
                ...
                <DeleteModal
                  ...
                  title={"Delete News"}
                  description={`Are you sure you want to delete ${healthNews?.title}`}
                  onSubmit={() => dispatch(DeleteHealthNewsService(healthNews?._id))} />
              </TableRow>
            ))}
          </TableBody>
        </Table>
