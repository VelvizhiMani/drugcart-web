          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-6 gap-1 text-center">
            ...
            <div className="col-span-3 text-white p-4 pt-3">
              <div className="flex items-center border-solid border-2 border-gray-200 w-full h-9 bg-bgcolor text-white rounded-full justify-center">
                ...
                <h4 className="bg-bgcolor ps-2 pe-2 placeholder-white text-white">
                  Pincode
                </h4>
                <input
                  type="text"
            ...
            <div
              className=" text-white p-1 pt-3 w-full
                    "
            >
              <div className="flex">
                <button
                  type="button"
                  className="text-white bg-bgcolor hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-1.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="size-6 text-black mt-1 ml-5"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="flex mt-1">
                {login ? (
                  <>
                    <div className="flex">
                      <svg
                        className="w-6 h-6 fill-sky-100  stroke-sky-500 stroke-2 text-gray-800 dark:text-white"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  <>
                    <div className="flex w-36">
                      ...
                      <h2 className="text-md ml-2 mr-10">My Account</h2>
                    </div>
                  </>
                )}
