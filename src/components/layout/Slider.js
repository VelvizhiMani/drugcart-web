                    ...
                    <div className='bg-gray-100 py-2'>
                        <div className='flex flex-wrap pl-8 md:pl-14'>
                            <div className='p-1 w-full md:w-1/3 lg:w-1/5'>
                                <div className='flex'>
                                    <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-8 text-white my-auto rounded-3xl bg-bgcolor p-1 overflow-hidden" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className='p-1 w-full md:w-1/3 lg:w-1/5'>
                                <div className='flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-8 my-auto text-white rounded-2xl bg-bgcolor p-1 overflow-hidden">
                ...
                <div className='container mx-auto'>
                    <div className='grid grid-cols-1 md:grid-cols-6 gap-4 px-10'>
                        <div className='md:col-span-4 col-span-1 justify-items-center border border-gray-100 p-2'>
                            <Image src={BannerImg} alt="Banner" className='object-contain w-full' />
                        </div>
                        <div className='md:col-span-2 col-span-1 pt-3 justify-items-center border border-gray-100'>
                            <Image src={Righttop} alt="Banner" className='object-contain w-full md:w-11/12 h-60 md:h-44 mb-3 rounded-md' />
                            <Image src={Rightbottom} alt="Banner" className='object-contain w-full md:w-11/12 h-60 md:h-44 rounded-md' />
                        </div>
                    </div>
                </div>
            </section>
