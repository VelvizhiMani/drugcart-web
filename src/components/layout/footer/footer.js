            ...
            <section className='bg-bgcolor'>
                <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-2 p-4'>
                    ...
                    <div className='col-span-2 text-center'>
                        <h4 className='text-white text-2xl pb-4'>We offer 24/7 dedicated support</h4>
                        <p className='text-white text-sm'>If you need support send us a message</p>
                    </div>
                    <div className="flex items-center p-2">
                        <input
                            ...
                            className="w-36 px-1 py-2 h-8 border-red-100 text-gray-700 focus:outline-none rounded-l"
                        />
                        <button
                            // onClick={handleSearch}
                            className="flex items-center h-8 justify-center bg-green-500 text-gray-700 px-4 py-2 rounded-r hover:bg-gray-100 focus:outline-none"
                        >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_1607_8161)">
                                    <path d="M14 7.5L18 12M18 12L14 16.5M18 12H6M12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </g>
                            </svg>
                    ...
                    <div className="flex-1 text-sm text-white">
                        ...
                        <div className='flex gap-1 justify-center'>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-white" viewBox="0 0 30 30" width="32px" height="32px">
                        ...
                        <div className="col-span-2 py-3">
                            ...
                            <div className='flex gap-3'>
                                <Image
                                    priority
                                    src={appstoreIcon}
                                    alt="call us" className='w-36 object-cover' />
                                <Image
                                    priority
                                    src={googlepayIcon}
                                    alt="call us" className='w-36 object-cover' />
