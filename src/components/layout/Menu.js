        ...
        <nav className="bg-white mt-5 text-black border-t-2 border-b-2 border-gray-100 font-[family-name:var(--font-poppins)] text-sm">
                ...
                <div className="flex justify-between h-12 items-center">
                    ...
                    <div className="flex items-center ml-3">
                        <Link href="/" className="text-md font-medium text-black">
                            <div className='flex items-center'>
                                ...
                                <span>View Categories Vel</span> </div>
                        </Link>
                    </div>
                    ...
                    <div className="hidden md:flex space-x-4">
                        ...
                        <div className="relative group">
                            <button className="px-3 py-2 rounded-md hover:bg-gray-700">Ayush</button>
                            <div className="absolute left-0 mt-0 hidden group-hover:block bg-white text-gray-800 rounded-md shadow-lg w-40">
                                <Link href="/category/ayurvedic" className="block px-4 py-2 hover:bg-gray-100">
                                    Ayurvedic
                                </Link>
                                <Link href="/category/homeopathy" className="block px-4 py-2 hover:bg-gray-100">
                                    Homeopathy
                                </Link>
                                <Link href="/category/siddha" className="block px-4 py-2 hover:bg-gray-100">
                                    Siddha
                                </Link>
                                <Link href="/category/unani" className="block px-4 py-2 hover:bg-gray-100">
                                    Unani
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            <button className="px-3 py-2 rounded-md hover:bg-gray-100">Scan</button>
                            <div className="absolute left-0 mt-0 hidden group-hover:block bg-white text-gray-800 rounded-md shadow-lg w-40">
                    ...
                    >
                        ...
                        {isMenuOpen ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            ...
            <Link href="/" className="block px-4 py-2 hover:bg-white">
                ...
                <Link
                    ...
                    onClick={() => setSubmenuOpen(submenuOpen === 'ayush' ? null : 'ayush')}
                >
                    Ayush
                </Link>
                {submenuOpen === 'ayush' && (
                ...
                <Link
                    href="#"
                    className="block px-4 py-2 hover:bg-white"
                    onClick={() => setSubmenuOpen(submenuOpen === 'healthcare' ? null : 'healthcare')}
                >
                    Health Care
                </Link>
                ...
                <Link
                    href="#"
                    className="block px-4 py-2 hover:bg-white"
                    onClick={() => setSubmenuOpen(submenuOpen === 'healthstore' ? null : 'healthstore')}
                >
                    Health Store
                </Link>
                ...
                <Link
                    href="#"
                    className="block px-4 py-2 hover:bg-white"
                    onClick={() => setSubmenuOpen(submenuOpen === 'services' ? null : 'services')}
                >
                    Services
                </Link>
