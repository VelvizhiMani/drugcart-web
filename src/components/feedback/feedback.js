  ...
  return (
    <section className='px-10 mt-5'>
        <div className='bg-bgclient rounded-md px-10'>
          <h1 className='font-bold text-xl text-center p-8'>Our Clients Feedback</h1>
          <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 text-center md:text-left px-5 pb-10'>
            <div className='bg-white rounded-lg p-10 px-5'>
              ...
              <div className='flex text-yellow-400 justify-center mt-6'>
                <h3 className='font-bold pr-1 mt-1 text-black'>4.0</h3>
